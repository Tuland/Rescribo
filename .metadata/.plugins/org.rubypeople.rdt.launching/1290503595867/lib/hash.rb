...
class Hash < Object
  ...
  # ------------------------------------------------------------------------
  #      Returns +true+ if _hash_ and _other_ are both hashes with the same
  #      content.
  # 
  def eql?(arg0)
  end
  ...
  # ------------------------------------------------------------------------
  #      Adds the contents of _other_hash_ to _hsh_. If no block is
  #      specified entries with duplicate keys are overwritten with the
  #      values from _other_hash_, otherwise the value of each duplicate key
  #      is determined by calling the block with the key, its value in _hsh_
  #      and its value in _other_hash_.
  # 
  #         h1 = { "a" => 100, "b" => 200 }
  #         h2 = { "b" => 254, "c" => 300 }
  ...
  #      to _key_. If the key is not found, returns +nil+. If the optional
  #      code block is given and the key is not found, pass in the key and
  #      return the result of _block_.
  # 
  #         h = { "a" => 100, "b" => 200 }
  #         h.delete("a")                              #=> 100
  #         h.delete("z")                              #=> nil
