...
Includes:
---------
     Literal(to_ntriple, xsd_type), Precision(prec, prec_f, prec_i)
...
-----------------
     ...
     integer?, lcm, next, numerator, odd?, ord, pred, prime_division,
     round, succ, times, to_i, to_int, to_r, to_s_lex, to_s_pad,
     to_yaml, truncate, upto
