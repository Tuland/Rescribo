...
-----------------
     %, &, *, **, **, +, -, -@, /, /, <, <<, <=, <=>, ==, >, >=, >>, [],
     ^, abs, dclone, div, divmod, even?, fdiv, id2name, modulo, odd?,
     power!, quo, quo, rdiv, rpower, size, to_f, to_s, to_sym, zero?, |,
     ~
...
class Fixnum < Integer
  ...
  # ------------------------------------------------------------------------
  #      Returns +true+ if _fix_ is an even number.
  # 
  def even?
  end
  ...
  # ------------------------------------------------------------------------
  #      Returns +true+ if _fix_ is an odd number.
  # 
  def odd?
  end
  ...
  # ------------------------------------------------------------------------
  #      Returns the floating point result of dividing _fix_ by _numeric_.
  # 
