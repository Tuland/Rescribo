...
-----------------
     %, &, *, **, **, +, -, -@, /, /, <<, <=>, ==, >>, [], ^, abs,
     coerce, div, divmod, eql?, fdiv, hash, modulo, power!, quo, quo,
     rdiv, remainder, rpower, size, to_f, to_s, |, ~
...
class Bignum < Integer
  ...
  # ------------------------------------------------------------------------
  #      Returns the floating point result of dividing _big_ by _numeric_.
  # 
