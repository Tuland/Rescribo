...
-----------------
     ...
     at_exit, autoload, autoload?, binding, binding_n, block_given?,
     breakpoint, callcc, caller, catch, chomp, chomp!, chop, chop!,
     debugger, eval, exec, exit, exit!, fail, fork, format, gem, getc,
     gets, global_variables, gsub, gsub!, instance_exec, iterator?,
