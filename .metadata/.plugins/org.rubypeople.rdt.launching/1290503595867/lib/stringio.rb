...
Instance methods:
-----------------
     <<, binmode, bytes, chars, close, close_read, close_write, closed?,
     closed_read?, closed_write?, each, each_byte, each_char, each_line,
     eof, eof?, fcntl, fileno, flush, fsync, getbyte, getc, gets,
     isatty, length, lineno, lineno=, lines, path, pid, pos, pos=,
     print, printf, putc, puts, read, readbyte, readchar, readline,
     readlines, reopen, rewind, seek, size, string, string=, sync,
     sync=, sysread, syswrite, tell, truncate, tty?, ungetc, write
